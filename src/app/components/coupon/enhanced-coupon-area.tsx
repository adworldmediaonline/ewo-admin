          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm text-blue-800">
                <span className="font-medium">Admin Access:</span> You have full access to coupon management and analytics.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-xl font-bold text-blue-900">{coupons?.length || 0}</p>
                      </div>
                    </div>
                  </div>
