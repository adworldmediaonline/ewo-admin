...
export default function OrderDetailsArea({ id }: OrderDetailsAreaProps) {
  ...
  const handleRefundConfirm = async () => {
    try {
      ...
      const refundAmountText = result.stripeRefund
        ? `$${result.stripeRefund.amount.toFixed(2)}`
        : 'Full amount';

      alert(
        `Refund processed successfully!\n\nRefund Amount: ${refundAmountText}\nStripe Refund ID: ${
          result.stripeRefund?.id || 'N/A'
  ...
  const canRefund = !['refunded', 'cancelled'].includes(
          ...
          <div className={styles.modalOverlay}>
            <div className={styles.modal}>
              <div className={styles.modalHeader}>
                <h3 className={styles.modalTitle}>Confirm Refund</h3>
                <button
              ...
              <div className={styles.modalContent}>
                <div className={styles.modalWarning}>
                  <AlertCircle className={styles.modalWarningIcon} />
                  <p>Are you sure you want to refund this order?</p>
                </div>
                <div className={styles.modalOrderInfo}>
                  <p>
                    <strong>Order:</strong> #{order.orderId || order.invoice}
                  </p>
                  <p>
                ...
                <div className={styles.modalReasonSection}>
                  <label htmlFor="refundAmount" className={styles.modalLabel}>
                  ...
                  <input
                    ...
                    placeholder={`Enter amount (max: $${order.totalAmount?.toFixed(
                      2
                    )})`}
                  />
              ...
              <div className={styles.modalActions}>
                ...
                <button
                  ...
                  disabled={isRefunding}
                >
                  {isRefunding ? 'Processing...' : 'Yes, Refund Order'}
                </button>
              </div>
            </div>
          </div>
